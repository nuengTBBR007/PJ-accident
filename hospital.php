...
<center>
<form id="form1" name="form1" method="post" action="massage.php" enctype="multipart/form-data">
...
<center><table width="200" border="0"style="margin-top: 1%;">
<div style="margin-top:3%"><font style="font-size:24px">ข้อมูลสถานพยาบาล</font></div>
  <tr>
    <td><img src="images/h1.gif" width="250" height="200" style= "margin-top:0%; margin-bottom:6px; margin-left:0%"/></td>
    <td><img src="images/h2.gif" width="250" height="200" style= "margin-top:0%; margin-bottom:6px; margin-left:0%"/></td>
    <td><img src="images/h3.gif" width="250" height="200 " style= "margin-top:0%; margin-bottom:6px; margin-left:0%"/></td>
    
  </tr>
  <tr>
  <center> 
<center>  <td><img src="images/h11.jpg" width="250px" height="100px" onclick="window.location.href='http://www.nopparat.go.th/nrhweb/history.php'" style= "margin-top:0%"/></td></center>
    <center><td><img src="images/h21.jpg" width="250px" height="100px" onclick="window.location.href='http://www.karunvej.com/pathumthani/th/site/about_us'" style= "margin-top:0%"/></td></center>
     <center><td><img src="images/h31.jpg" width="250px" height="100px" onclick="window.location.href='https://www.honestdocs.co/hospitals/bhumibol-adulyadej-hospital'" style= "margin-top:0%"/></td></center>
     </tr>
</table>
</center>
</body>
